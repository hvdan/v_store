...
/*!***************************************************!*\
  !*** ./resources/backend/js/dynamic-pie-chart.js ***!
  \***************************************************/
(function () {
  ...
  Array.prototype.forEach.call(pieCharts, function (wrapperEl) {
    ...
    wrapperEl.appendChild(percentageEl); // Setting up the values we're gonna use to draw our circles

    var center = diameter;
    var radius = center - strokeWidth;
    var startAngle = degreesToRadians(-90);
    var fullCircle = degreesToRadians(365);
    var endAngle = startAngle + degreesToRadians(percentage / 100 * 365); // Draw our canvas! Note we're doubling our sizes so we look good on high res displays
